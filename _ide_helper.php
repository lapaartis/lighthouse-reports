...
')
     ...
     */ 
        ...
        public static function for($name, $callback)
        {
                        /** @var \Rawilk\Breadcrumbs\Breadcrumbs $instance */
                        return $instance->for($name, $callback);
        }
                    /**
        ...
        public static function macro($name, $macro)
        {
                        \Rawilk\Breadcrumbs\Breadcrumbs::macro($name, $macro);
        }
                    /**
         * Mix another object into the class.
         *
        ...
        public static function mixin($mixin, $replace = true)
        {
                        \Rawilk\Breadcrumbs\Breadcrumbs::mixin($mixin, $replace);
        }
                    /**
         * Checks if macro is registered.
         *
        ...
        public static function hasMacro($name)
        {
                        return \Rawilk\Breadcrumbs\Breadcrumbs::hasMacro($name);
        }
                    /**
         * Flush the existing macros.
         *
        ...
        public static function flushMacros()
        {
                        \Rawilk\Breadcrumbs\Breadcrumbs::flushMacros();
        }
     ...
     */ 
        ...
        public static function addStyle($style)
        {
                        ...
                        return $instance->addStyle($style);
        }
                    /**
         * 
         *
         ...
         * @static 
         */ 
        public static function outputStyles($force = false)
        {
                        /** @var \Rawilk\FormComponents\FormComponents $instance */
                        return $instance->outputStyles($force);
        }
                    /**
         * 
         *
        ...
        {
                        /** @var \Rawilk\FormComponents\FormComponents $instance */
                        return $instance->addScript($script);
        }
                    /**
         * 
         *
         ...
         * @static 
         */ 
        public static function outputScripts($force = false, $options = [])
        {
                        /** @var \Rawilk\FormComponents\FormComponents $instance */
                        return $instance->outputScripts($force, $options);
        }
                    /**
...
namespace  { 
            ...
            class Breadcrumbs extends \Rawilk\Breadcrumbs\Facades\Breadcrumbs {}
